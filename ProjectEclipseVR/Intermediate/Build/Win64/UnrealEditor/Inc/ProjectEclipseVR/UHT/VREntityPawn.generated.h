...
// IWYU pragma: private, include "VREntityPawn.h"
...
public: \
	DECLARE_CLASS(AVREntityPawn, AEntityPawn, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/ProjectEclipseVR"), NO_API) \
...
private: \
	...
	AVREntityPawn(const AVREntityPawn&); \
public: \
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, AVREntityPawn); \
	DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(AVREntityPawn); \
	DEFINE_DEFAULT_CONSTRUCTOR_CALL(AVREntityPawn) \
...
template<> PROJECTECLIPSEVR_API UClass* StaticClass<class AVREntityPawn>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID FID_Github_ProjectEclipse_ProjectEclipseVR_Source_ProjectEclipseVR_Public_VREntityPawn_h
